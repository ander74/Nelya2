...
public partial class ToggleExtH : ToggleButton {
    ...
    public static readonly DependencyProperty TitleProperty =
        DependencyProperty.Register("Title", typeof(string), typeof(ToggleExtH), new PropertyMetadata(null, null, OnCoerceTitle));
    ...
    public static readonly DependencyProperty IconFontTextProperty =
        DependencyProperty.Register("IconFontText", typeof(string), typeof(ToggleExtH), new PropertyMetadata(null, null, OnCoerceIconFontText));
    ...
    private static readonly DependencyProperty IconFontTextVisibilityProperty =
        DependencyProperty.Register("IconFontTextVisibility", typeof(Visibility), typeof(ToggleExtH), new PropertyMetadata(Visibility.Visible));
    ...
    private static readonly DependencyProperty TitleVisibilityProperty =
        DependencyProperty.Register("TitleVisibility", typeof(Visibility), typeof(ToggleExtH), new PropertyMetadata(Visibility.Visible));
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register("CornerRadius", typeof(CornerRadius), typeof(ToggleExtH), new PropertyMetadata(new CornerRadius(2)));
    ...
    public static readonly DependencyProperty OnMouseBrushProperty =
        DependencyProperty.Register("OnMouseBrush", typeof(Brush), typeof(ToggleExtH), new PropertyMetadata());
    ...
    public static readonly DependencyProperty OnPressBrushProperty =
        DependencyProperty.Register("OnPressBrush", typeof(Brush), typeof(ToggleExtH), new PropertyMetadata(Brushes.OldLace));
    ...
    public static readonly DependencyProperty CheckedBrushProperty =
        DependencyProperty.Register("CheckedBrush", typeof(Brush), typeof(ToggleExtH), new PropertyMetadata());
    ...
    public static readonly DependencyProperty CheckedBackgroundProperty =
        DependencyProperty.Register("CheckedBackground", typeof(Brush), typeof(ToggleExtH), new PropertyMetadata(Brushes.Azure));
    ...
    public static readonly DependencyProperty IconFontFamilyProperty =
        DependencyProperty.Register("IconFontFamily", typeof(FontFamily), typeof(ToggleExtH), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty IconFontSizeProperty =
        DependencyProperty.Register("IconFontSize", typeof(double), typeof(ToggleExtH), new PropertyMetadata(24d));
    ...
    public static readonly DependencyProperty IconFontColorProperty =
        DependencyProperty.Register("IconFontColor", typeof(Brush), typeof(ToggleExtH), new PropertyMetadata(Brushes.DimGray));
    ...
    private static readonly DependencyProperty IconFontMarginProperty =
        DependencyProperty.Register("IconFontMargin", typeof(Thickness), typeof(ToggleExtH),
    ...
    private static readonly DependencyProperty IconTextMarginProperty =
        DependencyProperty.Register("IconTextMargin", typeof(Thickness), typeof(ToggleExtH),
            new PropertyMetadata(new Thickness(4, 0, 4, 0)));
    ...
    public static readonly DependencyProperty IconSeparationProperty =
        DependencyProperty.Register("IconSeparation", typeof(int), typeof(ToggleExtH), new PropertyMetadata(8, null, OnCoerceIconSeparation));
