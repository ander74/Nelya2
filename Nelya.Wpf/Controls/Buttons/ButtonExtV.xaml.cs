...
public partial class ButtonExtV : Button {
    ...
    public static readonly DependencyProperty TitleProperty =
        DependencyProperty.Register("Title", typeof(string), typeof(ButtonExtV), new PropertyMetadata(null, null, OnCoerceTitle));
    ...
    public static readonly DependencyProperty IconFontTextProperty =
        DependencyProperty.Register("IconFontText", typeof(string), typeof(ButtonExtV), new PropertyMetadata(null, null, OnCoerceIconFontText));
    ...
    private static readonly DependencyProperty IconFontTextVisibilityProperty =
        DependencyProperty.Register("IconFontTextVisibility", typeof(Visibility), typeof(ButtonExtV), new PropertyMetadata(Visibility.Visible));
    ...
    private static readonly DependencyProperty TitleVisibilityProperty =
        DependencyProperty.Register("TitleVisibility", typeof(Visibility), typeof(ButtonExtV), new PropertyMetadata(Visibility.Visible));
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register("CornerRadius", typeof(CornerRadius), typeof(ButtonExtV), new PropertyMetadata(new CornerRadius(2)));
    ...
    public static readonly DependencyProperty OnMouseBrushProperty =
        DependencyProperty.Register("OnMouseBrush", typeof(Brush), typeof(ButtonExtV), new PropertyMetadata(Brushes.SandyBrown));
    ...
    public static readonly DependencyProperty OnPressBrushProperty =
        DependencyProperty.Register("OnPressBrush", typeof(Brush), typeof(ButtonExtV), new PropertyMetadata(Brushes.OldLace));
    ...
    public static readonly DependencyProperty IconFontFamilyProperty =
        DependencyProperty.Register("IconFontFamily", typeof(FontFamily), typeof(ButtonExtV), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty IconFontSizeProperty =
        DependencyProperty.Register("IconFontSize", typeof(double), typeof(ButtonExtV), new PropertyMetadata(24d));
    ...
    public static readonly DependencyProperty IconFontColorProperty =
        DependencyProperty.Register("IconFontColor", typeof(Brush), typeof(ButtonExtV), new PropertyMetadata(Brushes.DimGray));
    ...
    private static readonly DependencyProperty IconFontMarginProperty =
        DependencyProperty.Register("IconFontMargin", typeof(Thickness), typeof(ButtonExtV),
            new PropertyMetadata(new Thickness(0, 0, 0, 3)));
    ...
    private static readonly DependencyProperty IconTextMarginProperty =
        DependencyProperty.Register("IconTextMargin", typeof(Thickness), typeof(ButtonExtV),
    ...
    public static readonly DependencyProperty IconSeparationProperty =
        DependencyProperty.Register("IconSeparation", typeof(int), typeof(ButtonExtV), new PropertyMetadata(8, null, OnCoerceIconSeparation));
    ...
    private static object OnCoerceIconSeparation(DependencyObject d, object baseValue) {
        if (baseValue is int separacion) {
            d.SetValue(IconFontMarginProperty, new Thickness(0, 0, 0, separacion));
            d.SetValue(IconTextMarginProperty, new Thickness(0, separacion, 0, 0));
        } else {
            d.SetValue(IconFontMarginProperty, new Thickness(0, 0, 0, 3));
            d.SetValue(IconTextMarginProperty, new Thickness(0, 3, 0, 0));
        }
        return baseValue;
    }
